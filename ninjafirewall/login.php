...
// Disply login error:
html_header();
html_body( 0, sprintf( $danger, _('Wrong username or password.') .'<br />'. sprintf( _('Use <a href="%s">this script</a> if you need to reset your password.'), 'http://cryptobank.local/ninjafirewall/pro2-reset.txt' ) ) );
html_footer();
