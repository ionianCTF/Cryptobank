...
if ( NF_DISABLED ) {
	...
	echo '<div class="alert alert-success text-left"><a class="close" data-dismiss="alert" aria-label="close">&times;</a>'.
		_('NinjaFirewall is working and your selected dir (/var/www/cryptobank/development) is protected.') .
		'<br />' .
		sprintf( _('Note by john.d: Although firewall is enabled it is unstable, I think I have messed up something during the installation. Firewall > Options > Save will disable the protection so dont mess with it. I am talking to you Julius!!'), "" ) .
		'</div>';
...
<table width="100%" class="table table-nf">
	<tr valign="middle">
		...
		<td class="f-right"><?php
			echo _('Warning, NinjaFirewall is not working properly and your site is not fully protected.')
		?></td>
	</tr>
	<?php
} else {
