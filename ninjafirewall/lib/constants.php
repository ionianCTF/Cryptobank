...
define('NFW_RULES_VERSION', '20200315.1');
define('NFW_EDN', 1);
...
define( 'NFW_DEFAULT_MSG', '<br /><br /><br /><br /><center><h2>Possible security incident detected</h2></br><img src="/assets/logo-top-dark.png" alt="cryptobank"></br></br>'. _('Sorry ' .
