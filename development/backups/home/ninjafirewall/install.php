...
function nfw_regional_settings() {
	...
	// Make sure the user accepts cookie:
...
function nfw_system_requirements() {
	...
	if ( empty( $_SESSION['cookie_test'] ) ) {
		install_error(	_('Missing PHP session. Please make sure that your browser accepts cookies from this domain. Aborting installation') );
		exit;
	}
