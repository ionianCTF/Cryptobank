				...
				<div class="jumbotron" style="display: inline-block; width: 95%; height: 50%; margin: 5px; padding: 10px;">
					<div class="jumbotron" style="color: white; margin: 100px; height: 100%; width: 100%; background-color: #687a8e; float: left; margin: 0px; padding: 10px; text-align: left;">
						...
						<?php
							...
							echo "
								<h4>Your current balance: &#8383 ".(number_format($row['balance'],2))."</h4>
							";
						...
						<form method="post" class="form-group">
							...
							<br>
							<input type="submit" class="btn btn-navbar" style="background-color: #2d343b" name="send_amount" value="Transfer">
						</form>
						<br>
						<br>
						<a class="btn btn-navbar" style="background-color: #2d343b" href="home.php">Back</a>
					</div>
				</div>
			</div>
		</div>
