				...
				<div class="jumbotron" style="display: inline-block; width: 95%; height: 50%; margin: 5px; padding: 10px;">
					<div class="jumbotron" style="color: white; margin: 100px; height: 100%; width: 100%; background-color: #687a8e; float: left; margin: 0px; padding: 10px; text-align: left;">
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($res)){
								echo "
									...
									<br>
									<form>
										<input class='btn btn-navbar' style='background-color: #2d343b' type='submit' value='Apply now'>
									</form>
									<br>
									<br>
						...
						<form class="form-group" method="post">
							...
							<br>
							<input class="btn btn-navbar" style="background-color: #2d343b" type="submit" value="Add Comment">
						</form>
						
						-->
						<h3>Currently unavailable due to high demand, sorry!</h3>
						<br>
						<br>
						<a class="btn btn-navbar" style="background-color: #2d343b" href="view_loans.php">Back</a>
					</div>
				</div>
			</div>
		</div>
